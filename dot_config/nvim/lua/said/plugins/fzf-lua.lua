...
keymap("n", "<leader>fm", "<cmd>lua require('fzf-lua').marks()<CR>", opts)
keymap("n", "<leader>fr", "<cmd>lua require('fzf-lua').registers()<CR>", opts)
keymap("n", "<leader>fk", "<cmd>lua require('fzf-lua').keymaps()<CR>", opts)
keymap("n", "<leader>fe", "<cmd>lua require('fzf-lua').commands()<CR>", opts)
keymap("n", "<leader>fc", "<cmd>lua require('fzf-lua').colorschemes()<CR>", opts)
