...
vim.opt.scrolloff = 8 -- minimal number of screen ignines to keep above and below the cursor
vim.opt.sidescrolloff = 8 -- minimal number of screen columns to keep to the left and right of the cursor if wrap is `false`
vim.opt.background = "dark" -- set themes to dark default
...
-- vim.opt.shiftwidth = 0 -- Set `shiftwidth` to the same as `tabstop`

vim.opt.ls = 0
vim.opt.ch = 0

-- Set the winbar to the statusline.
-- vim.opt.wbr = vim.o.stl
